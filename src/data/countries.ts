// ISO 3166-1 sovereign states + commonly-recognised territories.
...
export const COUNTRIES: Country[] = [
  ...
  { code: "RU", name: "Russia" }, { code: "RW", name: "Rwanda" }, { code: "RE", name: "Réunion" },
  ...
  { code: "VI", name: "US Virgin Islands" }, { code: "UZ", name: "Uzbekistan" }, { code: "VU", name: "Vanuatu" },
